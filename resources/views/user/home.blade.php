...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a href="" class="{{url('/')}}"><img class="w-50" src="../assets/img/logo.png" alt="Error" ></a>
    ...
    <div class="container">
      ...
      @foreach($latest as $news)
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog" style="height:auto">
            <div class="header">
              <div class="post-category">
                <a href="#">Covid19</a>
              </div>
              <a href="blog-details.html" class="post-thumb">
                <img src="latestimage/{{$news->image}}" alt="">
              </a>
            </div>
            <div class="body">
              ...
              <div class="site-info">
                ...
                <span class="mai-time"></span> {{$news->date}}
              </div>
            </div>
          </div>
        </div>
  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <a href="#" class="footer-link">+212601901136</a>
          <a href="#" class="footer-link">BadrHospital@temporary.net</a>
